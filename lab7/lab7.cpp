...
int APIENTRY wWinMain(HINSTANCE hInstance, HINSTANCE, LPWSTR, int nCmdShow) {
    ...
    wcex.lpszClassName = L"Romanchuk HW_7";
...
HRESULT CreateCubeResources() {
    ...
    ImGui_ImplWin32_Init(FindWindow(L"Romanchuk HW_7", L"Romanchuk HW_7"));
...
void RenderScene(bool renderToBackbuffer) {
    ...
    RECT rc;
    GetClientRect(FindWindow(L"Romanchuk HW_7", L"Romanchuk HW_7"), &rc);
